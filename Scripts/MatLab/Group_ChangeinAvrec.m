function Group_ChangeinAvrec(homedir)
...
run('KIV.m')
KIVan = animals;
clear animals Cond Layer channels
group = {'KIC','KIT','KIV'};
stimtype = {'CL','AM'};
    ...
    for iLay = 1:length(layers)
        ...
        for iGroup = 1:length(group)
            ...
            for iStim = 1:length(stimlist)
                ...
                title([stimtype{istim} ' ' layers{iLay} ' ' group{iGroup} ' ' num2str(stimlist(iStim)) ' Hz'])
                ...
                cond1 = stackedgroup(1:5:end,:); % pre laser
                cond2 = stackedgroup(2:5:end,:); % post 1
                % if desired, here are the post measurments 2, 3, and 4
